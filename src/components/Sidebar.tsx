                ...
                {items.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* w-full pins the span to the button width so long labels stay inside
                             * the sidebar instead of pushing past it. The 8px size + dropped
                             * tracking-wider buys enough room for NOTIFICATIONS / APPEARANCE to
                             * sit on a single line at the current sidebar width. */}
                            <span className={`w-full text-[8px] font-semibold uppercase mt-1 leading-tight text-center ${isActive ? 'text-white' : 'text-gray-500 group-hover:text-gray-300'}`}>
                                {item.label}
                            </span>
